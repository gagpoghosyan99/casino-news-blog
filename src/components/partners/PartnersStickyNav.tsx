...
export default function PartnersStickyNav({ items, ariaLabel }: PartnersStickyNavProps) {
    ...
    <div className="sticky top-[88px] z-40 border-b border-gold-400/15 bg-gradient-to-b from-[#080b14]/95 to-[#05070f]/92 shadow-[0_12px_40px_rgba(0,0,0,0.35)] backdrop-blur-2xl md:top-[132px] lg:top-[88px]">
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <Link
          ...
          className="shrink-0 text-[12px] font-semibold text-slate-400 transition hover:text-gold-300"
        >
          ← All Partners
        </Link>
