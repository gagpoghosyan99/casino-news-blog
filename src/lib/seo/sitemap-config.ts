...
export function buildStaticSitemapRoutes(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/bonuses`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.85 },
    { url: `${base}/jackpots`, lastModified: new Date(), changeFrequency: "daily", priority: 0.85 },
    { url: `${base}/crypto`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.85 },
