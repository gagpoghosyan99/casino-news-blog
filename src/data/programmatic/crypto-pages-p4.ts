...
export const p4CryptoPages: ProgrammaticPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "TRC-20 vs ERC-20 USDT Comparison (Editorial Summary)",
        body: "Use this table as a starting point — always confirm labels in your logged-in cashier before sending funds.\n\n| Factor | TRC-20 (Tron) | ERC-20 (Ethereum) |\n|--------|---------------|-------------------|\n| Typical transfer fee | Often low on Tron | Gas-dependent; can be high |\n| Confirmation speed | Often minutes | Varies with gas and congestion |\n| Common mistake | Sending ERC-20 to Tron address | Sending TRC-20 to Ethereum address |\n| Best when | Operator lists TRC-20; exchange defaults to Tron | Funds already on Ethereum mainnet |\n| Withdrawal path | Must usually match deposit network | Must usually match deposit network |\n\nSee [USDT ERC-20 guide](/crypto/usdt-erc20-casino) for gas-specific detail. Wrong-network mistakes are often irreversible. South Asia context: [2026 payment methods report](/reports/south-asia-casino-payments-2026).",
      },
      {
        heading: "Pre-Deposit Verification Checklist",
