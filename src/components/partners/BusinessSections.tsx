...
export function BusinessPartnerTypes({ onInquire }: { onInquire: (preset: string) => void }) {
  return (
    <section id="for-businesses" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <SectionReveal>
        <p className="text-xs font-bold uppercase tracking-[0.25em] text-gold-400">Partner with ZeoneBet</p>
        <h2 className="mt-2 zb-headline text-2xl md:text-3xl">Business partnerships</h2>
        <p className="mt-4 max-w-3xl text-sm leading-relaxed text-slate-400 sm:text-base">
          We work with established iGaming companies, emerging brands and specialist service providers
          through transparent, flexible partnership models.
        </p>
      </SectionReveal>
