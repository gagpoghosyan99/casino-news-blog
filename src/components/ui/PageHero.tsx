...
import HeroCasinoShowcase from "@/components/ui/HeroCasinoShowcase";
...
interface PageHeroProps {
  ...
  /** Animated slot machine on the right. Default true. */
  showcase?: boolean;
}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-32 lg:px-8">
        <div
          className={`grid items-center gap-10 lg:gap-12 ${
            showcase ? "lg:grid-cols-[1.05fr_0.95fr]" : ""
          }`}
        >
          <motion.div
          ...
          >
            ...
            <h1 className="mt-4 zb-headline text-3xl sm:text-4xl lg:text-[2.75rem] xl:text-[3.15rem] xl:leading-[1.1]">
        ...
        {/* Mobile: compact showcase under CTAs */}
        {showcase && (
        ...
        <motion.div
          ...
          className="mt-12 h-px origin-left bg-gradient-to-r from-gold-400/70 via-gold-400/20 to-transparent"
        />
      </div>
    </section>
  );
